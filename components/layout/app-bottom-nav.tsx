...
import { Swords, BarChart3, UserCircle, type LucideIcon } from "lucide-react";
...
const navLinks: NavLinkItem[] = [
  { href: "/", label: "Арена", icon: Swords, primary: true },
...
export function AppBottomNav() {
  ...
  return (
    ...
    >
      <div className="flex w-full items-stretch sm:mx-auto sm:items-center sm:justify-center sm:gap-1 sm:overflow-x-auto sm:rounded-2xl sm:p-1.5">
        {navLinks.map((link) => {
